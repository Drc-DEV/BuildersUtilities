...
public class OptionsInventory {
    ...
    public static void update(Inventory inv, Player p) {
        ItemStack GREEN = ItemUtils.create(Material.LIME_STAINED_GLASS_PANE, 1, "&7");
        ItemStack ORANGE = ItemUtils.create(Material.ORANGE_STAINED_GLASS_PANE, 1, "&7");
        ItemStack RED = ItemUtils.create(Material.RED_STAINED_GLASS_PANE, 1, "&7");
