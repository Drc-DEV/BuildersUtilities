...
public class BannerInventory {
    ...
    public static Inventory generateColorInventory(ItemStack oldBanner) {
        ...
        inv.setItem(28, ItemUtils.create(Material.INK_SAC, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        inv.setItem(29, ItemUtils.create(Material.ROSE_RED, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        inv.setItem(30, ItemUtils.create(Material.CACTUS_GREEN, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        inv.setItem(31, ItemUtils.create(Material.COCOA_BEANS, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        inv.setItem(32, ItemUtils.create(Material.LAPIS_LAZULI, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        ...
        inv.setItem(40, ItemUtils.create(Material.DANDELION_YELLOW, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
        ...
        inv.setItem(44, ItemUtils.create(Material.BONE_MEAL, 1, MessageUtils.getMessageList("messages.inventories.banner.select")));
